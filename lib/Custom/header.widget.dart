// ignore_for_file: prefer_const_constructors, library_private_types_in_public_api, no_logic_in_create_state, prefer_final_fields
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          ...
          //     decoration: BoxDecoration(
          //       gradient: LinearGradient(
          //           colors: [AppColors.primaryColor, AppColors.dark],
          //           begin: const FractionalOffset(0.0, 0.0),
          //           end: const FractionalOffset(1.0, 0.0),
          //           stops: [0.0, 1.0],
          //           tileMode: TileMode.clamp),
